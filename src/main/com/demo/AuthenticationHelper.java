// Authentication Helper — The Main Logic that passes through Cognito
...
public class AuthenticationHelper {
    ...
    private byte[] getPasswordAuthenticationKey(String userId,
        ...
        Hkdf hkdf; //  [Hash-based-message-authentication-code] (HMAC)-based Key Derivation Function \\ Essentially a cryptographic extraction and key derivation
